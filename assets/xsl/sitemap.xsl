  ...
  <xsl:template match="/">
    <html>
      <head>
        ...
        <script type="text/javascript" src="/plugins/xeor/sitemap/assets/js/jquery.js"></script>
        <script type="text/javascript" src="/plugins/xeor/sitemap/assets/js/jquery.tablesorter.min.js"></script>
        <script type="text/javascript" src="/plugins/xeor/sitemap/assets/js/sitemap.xsl.js"></script>
        <link href="/plugins/xeor/sitemap/assets/css/sitemap.xsl.css" type="text/css" rel="stylesheet"/>
      </head>
      ...
      <body>
        ...
        <div id="footer">
          <p>Generated by the
            ...
            and the
            <a href="https://github.com/sozonovalexey/wn-sitemap-plugin">Sitemap plugin</a>.
          </p>
        </div>
      </body>
    </html>
